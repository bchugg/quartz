...
- If $(\Omega,\cZ)$ is arbitrage-free (see [[game-theoretic probability#Gamble spaces, prices, and probabilities|game-theoretic probability-Gamble spaces, prices, and probabilities]]]) then $\ov{\E}[0]\leq 0$. 
